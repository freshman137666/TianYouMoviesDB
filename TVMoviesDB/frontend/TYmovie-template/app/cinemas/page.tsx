...
import { CinemaFilters } from "@/components/cinema-filters"
        ...
        <div className="bg-white shadow-sm">
          <div className="container mx-auto px-4 py-3 flex items-center">
            ...
            <div className="ml-6 flex space-x-6 text-sm">
              <a href="/films" className="text-gray-600 hover:text-red-600">
                正在热映
              </a>
              <a href="/films/upcoming" className="text-gray-600 hover:text-red-600">
                即将上映
              </a>
              <a href="/cinemas" className="text-red-600 font-medium">
                影院
              </a>
