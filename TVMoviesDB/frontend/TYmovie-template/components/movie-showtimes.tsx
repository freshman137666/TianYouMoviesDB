...
export function MovieShowtimes({ movieId }) {
  ...
  const areas = ["全城", "朝阳区", "海淀区", "东城区", "西城区", "丰台区"]
                      ...
                      <div key={showTime.id} className="border border-gray-200 rounded p-3">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <Link href={`/movie/${movieId}/select-seats?cinemaId=${cinema.id}&showTimeId=${showTime.id}`}>
                            <Button className="bg-red-600 hover:bg-red-700 text-white text-sm h-8">选座</Button>
                          </Link>
                        </div>
                      </div>
                    ))}
